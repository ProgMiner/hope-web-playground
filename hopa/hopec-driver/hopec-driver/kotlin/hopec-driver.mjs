...
import { importObject, setWasmExports } from './hopec-driver.import-object.mjs'
...
const wasmFilePath = './hopec-driver.wasm';
...
try {
  ...
  if (isBrowser) {
    wasmInstance = (await WebAssembly.instantiateStreaming(fetch(new URL('./hopec-driver.wasm',import.meta.url).href), importObject, wasmOptions)).instance;
  }
} catch (e) {
