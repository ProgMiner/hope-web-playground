...
data class Program(
    val list: List<AstNode.TopLevelNode>,
)
...
sealed interface AstNode {
    ...
    data class FunctionDeclaration(
        val name: String,
        val equations: List<FunctionEquation>,
    ...
    data class TypeExportDeclaration(
    ...
    data class LambdaExpr(
        val branches: List<LambdaBranch>,
    ) : Expr

    data class LambdaBranch(
        val pattern: Pattern,
        val expression: Expr,
    )
