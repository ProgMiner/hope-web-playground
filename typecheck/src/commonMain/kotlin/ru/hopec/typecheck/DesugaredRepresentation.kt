...
internal data class DesugaredRepresentation(val modules: Map<String, Module>, val topLevel: Declarations) {
    /**
    ...
    data class Declarations(
        ...
        data class Function(val lambda: Expr.Lambda, val type: TypedRepresentation.PolymorphicType)
    }
    ...
    sealed interface Expr {
         ...
         */
        data class Identifier(val name: TypedRepresentation.Declarations.Function.Name) : Expr
